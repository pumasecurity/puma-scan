...
namespace Puma.Security.Rules.Analyzer.Validation.Path
{
    ...
    public class FileStreamAnalyzer : ISyntaxNodeAnalyzer
    {
        private readonly IFileStreamExpressionAnalyzer _expressionSyntaxAnalyzer;

        public FileStreamAnalyzer(IFileStreamExpressionAnalyzer expressionSyntaxAnalyzer)
        {
        ...
        public IEnumerable<DiagnosticInfo> GetDiagnosticInfo(SyntaxNodeAnalysisContext context)
        {
            ...
            result.Add(new DiagnosticInfo(syntax.GetLocation(), "FileStream"));
