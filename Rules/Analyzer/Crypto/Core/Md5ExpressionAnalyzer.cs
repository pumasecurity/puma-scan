...
{
    internal class Md5ExpressionAnalyzer : IMd5ExpressionAnalzyer
    {
        ...
        {
            return string.Compare(syntax?.Type.ToString(), "MD5CryptoServiceProvider", StringComparison.Ordinal) == 0;
        }
