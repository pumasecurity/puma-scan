...
{
    public class ExpressionSyntaxAnalyzer : BaseExpressionSyntaxAnalyzer<ExpressionSyntax>
    {
        public override bool CanSuppress(SemanticModel model, ExpressionSyntax syntax)
        {
            var expressionSyntaxAnalyzer = ExpressionSyntaxAnalyzerFactory.Create(syntax);
