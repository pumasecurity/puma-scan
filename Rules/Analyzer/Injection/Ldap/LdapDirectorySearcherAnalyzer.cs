...
namespace Puma.Security.Rules.Analyzer.Injection.Ldap
{
    ...
    internal class LdapDirectorySearcherAnalyzer : BaseCodeBlockAnalyzer, ISyntaxAnalyzer
    {
        ...
        internal LdapDirectorySearcherAnalyzer() : this(new LdapDirectorySearcherInjectionExpressionAnalyzer(), new InvocationExpressionVulnerableSyntaxNodeFactory()) { }

        private LdapDirectorySearcherAnalyzer(
            ILdapDirectorySearcherInjectionExpressionAnalyzer expressionSyntaxAnalyzer,
