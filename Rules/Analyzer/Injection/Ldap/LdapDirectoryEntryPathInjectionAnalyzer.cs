...
namespace Puma.Security.Rules.Analyzer.Injection.Ldap
{
    ...
    public class LdapDirectoryEntryPathInjectionAnalyzer : ISyntaxNodeAnalyzer
    {
        private readonly ILdapDirectoryEntryPathInjectionExpressionAnalyzer _expressionSyntaxAnalyzer;

        public LdapDirectoryEntryPathInjectionAnalyzer(ILdapDirectoryEntryPathInjectionExpressionAnalyzer expressionSyntaxAnalyzer)
        {
