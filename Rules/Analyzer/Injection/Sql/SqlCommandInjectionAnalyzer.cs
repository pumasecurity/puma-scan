...
namespace Puma.Security.Rules.Analyzer.Injection.Sql
{
    ...
    public class SqlCommandInjectionAnalyzer : ISyntaxNodeAnalyzer
    {
        private readonly ISqlCommandInjectionExpressionAnalyzer _expressionSyntaxAnalyzer;

        public SqlCommandInjectionAnalyzer(ISqlCommandInjectionExpressionAnalyzer expressionSyntaxAnalyzer)
        {
