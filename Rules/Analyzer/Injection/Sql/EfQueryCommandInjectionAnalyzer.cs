...
namespace Puma.Security.Rules.Analyzer.Injection.Sql
{
    ...
    public class EfQueryCommandInjectionAnalyzer : ISyntaxNodeAnalyzer
    {
        private readonly IEfQueryCommandInjectionExpressionAnalyzer _expressionSyntaxAnalyzer;

        public EfQueryCommandInjectionAnalyzer(IEfQueryCommandInjectionExpressionAnalyzer expressionSyntaxAnalyzer)
        {
