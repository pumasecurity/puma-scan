...
namespace Puma.Security.Rules.Suites
{
    ...
    public class WebFormsXssDiagnosticSuite : BaseSyntaxDiagnosticSuite
    {
        public WebFormsXssDiagnosticSuite()
        {
            Analyzers = new ISyntaxAnalyzer[]
            {
               new LiteralTextAnalyzer(),
               new LabelTextAnalyzer(),
               new ResponseWriteAnalyzer(),
            }.ToImmutableArray();
        }
    }
}