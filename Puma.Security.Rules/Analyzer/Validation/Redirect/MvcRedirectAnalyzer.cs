...
{
    [SupportedDiagnostic(DiagnosticId.SEC0109)]
    internal class MvcRedirectAnalyzer : BaseCodeBlockAnalyzer, ISyntaxAnalyzer
    {
        private readonly IMvcRedirectExpressionAnalyzer _expressionSyntaxAnalyzer;
        private readonly IInvocationExpressionVulnerableSyntaxNodeFactory _vulnerableSyntaxNodeFactory;

        internal MvcRedirectAnalyzer() : this(new MvcRedirectExpressionAnalyzer(), new InvocationExpressionVulnerableSyntaxNodeFactory()) { }

        private MvcRedirectAnalyzer(
            IMvcRedirectExpressionAnalyzer expressionSyntaxAnalyzer,
