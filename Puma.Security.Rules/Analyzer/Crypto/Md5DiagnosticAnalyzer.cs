...
{
    [SupportedDiagnostic(DiagnosticId.SEC0027)]
    internal class Md5DiagnosticAnalyzer : BaseSemanticAnalyzer, ISyntaxAnalyzer
    {
        private readonly IMd5ExpressionAnalzyer _expressionSyntaxAnalyzer;
        private readonly IObjectCreationExpressionVulnerableSyntaxNodeFactory _vulnerableSyntaxNodeFactory;

        internal Md5DiagnosticAnalyzer() : this(new Md5ExpressionAnalyzer(), new ObjectCreationExpressionVulnerableSyntaxNodeFactory()) { }

        private Md5DiagnosticAnalyzer(IMd5ExpressionAnalzyer expressionSyntaxAnalyzer,
