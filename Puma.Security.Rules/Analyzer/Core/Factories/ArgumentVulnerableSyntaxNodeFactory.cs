...
{
    internal class ArgumentVulnerableSyntaxNodeFactory : IArgumentVulnerableSyntaxNodeFactory
    {
        public VulnerableSyntaxNode Create(ArgumentSyntax syntaxNode, params string[] messageArgs)
        {
