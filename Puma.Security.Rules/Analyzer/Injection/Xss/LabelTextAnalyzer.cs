...
{
    [SupportedDiagnostic(DiagnosticId.SEC0105)]
    internal class LabelTextAnalyzer : BaseCodeBlockAnalyzer, ISyntaxAnalyzer
    {
        private readonly ILabelTextAssignmentExpressionAnalyzer _expressionSyntaxAnalyzer;
        private readonly IAssignmentExpressionVulnerableSyntaxNodeFactory _vulnerableSyntaxNodeFactory;

        internal LabelTextAnalyzer() : this(new LabelTextAssignmentExpressionAnalyzer(), new AssignmentExpressionVulnerableSyntaxNodeFactory()) { }

        private LabelTextAnalyzer(
            ILabelTextAssignmentExpressionAnalyzer expressionSyntaxAnalyzer,
